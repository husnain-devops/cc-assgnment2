...
function initializeIndices() {
  ...
  const endpoints = [
    { type: 'posts', url: 'http://posts-service:3000/api/posts' },
    { type: 'threads', url: 'http://threads-service:3000/api/threads' },
    { type: 'users', url: 'http://users-service:3000/api/users' }
  ];
